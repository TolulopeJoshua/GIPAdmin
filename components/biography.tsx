...
const Biography = ({biography}: {biography: biography}) => {
    ...
    <form className='w-5/12 px-1 h-full flex flex-col'>
        ...
        <div contentEditable={textMode} id={`${biography._id}_text`} className={'w-7/12 p-1 pb-8 h-full overflow-y-auto absolute right-0 top-0 scrollbar text-sm text-justify whitespace-pre-line ' + (textMode && 'bg-slate-200 text-black')}></div>
