...
const Article = ({article}: {article: article}) => {
  ...
  return (
    <div className='bg-white/5 w-[700px] border-y-4 border-slate-700 max-w-full rounded-md flex relative overflow-hidden'>
        ...
        <div contentEditable={textMode} id={`${article._id}_text`} className={'w-7/12 p-1 pb-8 h-full overflow-y-auto absolute right-0 top-0 scrollbar text-sm text-justify whitespace-pre-line ' + (textMode ? 'bg-slate-200 text-black' : 'bg-white/30')}></div>
